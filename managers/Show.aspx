...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:Panel ID="View1" runat="server" CssClass="clear">
        ...
        <div class='editbox'>
            <div>
                Summary:</div>
            <asp:TextBox ID="Summary" runat="server"  CssClass="editbox" Rows="4" TextMode="MultiLine" Enabled="false"/></div>
        <div class='editbox'>
            <div>
                Description:</div>
            <asp:TextBox ID="Description" runat="server" CssClass="editbox" Rows="4" TextMode="MultiLine" Enabled="false"/></div>
